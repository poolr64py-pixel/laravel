...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('user.property_management.categories') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
    ...
    {{-- create modal --}}
    @include('user.property-management.category.create')

    {{-- edit modal --}}
    @include('user.property-management.category.edit')
@endsection
