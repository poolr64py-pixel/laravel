...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('user.property_management.cities') }}" method="get" id="carSearchForm">
                                <div class="row">
    ...
    {{-- create modal --}}
    @include('user.property-management.city.create')

    {{-- edit modal --}}
    @include('user.property-management.city.edit')
@endsection
@section('scripts')
    <script>
        let stateUrl = "{{ route('user.property_management.get_state') }}";
    </script>
