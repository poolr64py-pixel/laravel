                                    ...
                                    <div class="version-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div
                                                    class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                    <label>{{ __('Minimum Price') . ' (' . $userBs->base_currency_text . ') '    }}  <span class="text-danger">{{ '*' }}</span></label>
                                                    ...
                                                    <div class="form-check py-0">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox"
                                                                onchange="cloneInput('collapse{{ $tenantFrontCurrLang->id }}', 'collapse{{ $language->id }}', event)">
                                                            <span
