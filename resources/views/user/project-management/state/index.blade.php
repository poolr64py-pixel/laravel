...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-title d-inline-block">{{ __('Project States') }}</div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('user.project_management.states') }}" method="get" id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('user.project_management.bulk_delete_state') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('user.project_management.delete_state') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('user.project-management.state.create')

    {{-- edit modal --}}
    @include('user.project-management.state.edit')
@endsection
