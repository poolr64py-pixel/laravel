                            ...
                            <div class="col-lg-6 offset-lg-3">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="project_country_status"
                                                    {{ $content->project_country_status == 1 ? 'checked' : '' }}
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio" name="project_country_status"
                                                    {{ $content->project_country_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="project_state_status"
                                                    {{ $content->project_state_status == 1 ? 'checked' : '' }}
                                                    value="1" class="selectgroup-input">
                                                <span class="selectgroup-button">{{ __('Active') }}</span>
                                            </label>
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio" name="project_state_status"
                                                    {{ $content->project_state_status == 0 ? 'checked' : '' }}
                                                    value="0" class="selectgroup-input">
                                                <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                            </label>
                                        </div>
