                                        ...
                                        <tbody>
                                            @foreach ($pages as $page)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($page->status == 1)
                                                            <h2 class="d-inline-block"><span class="badge badge-success">
                                                                    {{ __('Active') }} </span>
                                                            </h2>
                                                        @else
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1"
                                                            href="{{ route('user.custom_pages.edit_page', ['id' => $page->id]) }}">
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('user.custom_pages.delete_page', ['id' => $page->id]) }}"
                                                            method="post">
