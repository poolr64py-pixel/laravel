@props(['property', 'animate' => true, 'tenant' => null])
 ...
 <a href="{{ route('frontend.property.details', ['slug' => $property->slug ?? $property->propertyContent->slug]) }}">{{ $property->title ?? $property->propertyContent->title }}</a>
             </h3>
