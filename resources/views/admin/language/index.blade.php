                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.language.edit_admin_front_keyword', $language->id) }}">
                                                        ...
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.language.edit_admin_dashboard_keyword', $language->id) }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                        ...
                                                        <a class="btn btn-success btn-sm"
                                                            href="{{ route('admin.language.edit_user_dashboard_keyword', $language->id) }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                        ...
                                                        <a class="btn btn-success btn-sm"
                                                            href="{{ route('admin.language.edit_user_frontend_keyword', $language->id) }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
