                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label>{{ __('Name') }}</label>
                                                                <p>{{ !empty($membership->user) ? $membership->user->first_name . ' ' . $membership->user->last_name : '-' }}
                                                                </p>
                                                                <label>{{ __('Username') }}</label>
                                                                <p>{{ !empty($membership->user) ? $membership->user->username : '-' }}
                                                                </p>
                                                                <label>{{ __('Company') }}</label>
                                                                <p>{{ !empty($membership->user) ? $membership->user->company_name : '-' }}
                                                                </p>
                                                                <label>{{ __('Email') }}</label>
                                                                <p>{{ !empty($membership->user) ? $membership->user->email : '-' }}
                                                                </p>
