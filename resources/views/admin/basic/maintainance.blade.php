                            ...
                            <form id="maintenanceForm" action="{{ route('admin.maintainance.update') }}" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 showImage mb-3">
                                                <img src="{{ asset('assets/front/img/' . $bs->maintenance_img) }}"
                                                    alt="..." class="img-thumbnail">
                                            </div>
                                            <input type="file" name="file" id="image" class="form-control">
                                            <p id="errfile" class="mb-0 text-danger em"></p>
                                            <p class="text-warning mb-0">{{ __('Upload 770 * 720 image for best quality') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning">
                                        ...
                                        <strong class="text-danger">{{ url('{secret_path}') }}</strong></p>
