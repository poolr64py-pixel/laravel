                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-capitalize" name="email_type"
                                                value="{{ __($templateInfo->email_type) }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote" id="mailTemplateSummernote" name="email_body"
                                                placeholder="Enter Mail Body Format" data-height="300">{!! replaceBaseUrl($templateInfo->email_body, 'summernote') !!}</textarea>
