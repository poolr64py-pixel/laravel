...
<div class="page-header">
    <h4 class="page-title">{{ __('Add New Project') }}</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">{{ __('Add New Project') }}</div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.project.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="alert alert-info">
                        <strong>{{ __('Notice') }}:</strong> {{ __('Project will be created for user ID 148 (main site)') }}
                    </div>
                    ...
                    <div class="form-group mt-4">
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save"></i> {{ __('Save Project') }}
                        </button>
