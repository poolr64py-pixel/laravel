...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Post') }}</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($blogs) == 0)
                                <h3 class="text-center">{{ __('NO BLOG POST FOUND') }}</h3>
                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-info btn-sm" 
                                                            onclick="openTranslateModal({{ $blog->id }}, '{{ addslashes($blog->title) }}')">
                                                            <span class="btn-label">
                                                                <i class="fas fa-language"></i>
                                                            </span>
                                                            {{ __('Translate') }}
                                                        </button>
                                                        <form class="deleteform d-inline-block"                                                        <form class="deleteform d-inline-block"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxForm" enctype="multipart/form-data" class="modal-form"
                        ...
                        <input type="hidden" name="language" value="{{ $currentLang->id }}">
                        <div class="row">
                            <div class="col-lg-6">
