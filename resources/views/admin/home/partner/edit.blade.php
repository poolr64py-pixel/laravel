                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.partner.update') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0">{{ __('Upload 300 * 70 image for best quality') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">{{ __('URL') }} <span
                                            class="text-danger">{{ '*' }}</span></label>
                                    <input type="text" class="form-control " name="url" value="{{ $partner->url }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning">
                                        <small> {{ __('The higher the serial number is, the later will be shown') }}
                                        </small>
                                    </p>
                                </div>
                            </form>
