...
use App\Services\PaymentGateway\InstamojoService;
use Carbon\Carbon;
...
class InstamojoController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->instamojoService->setCredentials(true);
    }

    public function paymentProcess(Request $request, $_amount, $_success_url, $_cancel_url, $_title, $webCuryency)
    {

        $validCurrency = $this->instamojoService->checkCurrency($webCuryency, array("INR"));
        ...
        return $this->instamojoService->makePayment($_title, $_amount, $_success_url, $_cancel_url);
    }
    ...
    public function successPayment(Request $request)
    {
        ...
        if ($request['payment_request_id'] == $payment_id) {
            ...
            $requestData['payment_method'] = 'Instamojo';
