...
class AdditionalSectionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.home.additional-sections.index', $information);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.home.additional-sections.create', $information);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $information['all_sections'] = CustomSection::AdminFrontHomePage();
        return view('admin.home.additional-sections.edit', $information);
    }
