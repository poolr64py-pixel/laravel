...
{
    use HasFactory;
    public $table = "user_project_cities";
    protected $guarded = [];
    ...
    {
        return $this->belongsTo(Project::class, 'city_id', 'id');
    }
        ...
        if ($delete) {
            DB::transaction(
                function () use ($city) {
                    ...
                    @unlink(public_path('assets/img/project-city/') . $city->image);
                    $city->delete();
                }
            );
        }
