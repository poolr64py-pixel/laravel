                                    ...
                                    @foreach ($allPfeatures as $feature)
                                        <li
                                            ...
                                            @elseif ($feature === 'AI Content Generation')
                                                @php
                                                    $hasFeature =
                                                        is_array($pFeatures) && in_array($feature, $pFeatures);
                                                @endphp

                                                <i
                                                    class="{{ $hasFeature ? 'fal fa-check bg-success text-white' : 'fal fa-times bg-danger text-white' }}"></i>
                                                ...
                                                @if ($hasFeature)
                                                    <ul class="list-unstyled ms-4 small py-2">

                                                        <li class="mb-1">
                                                            <i class="fal fa-check bg-success text-white"></i>
                                                            {{ $package->ai_tokens === 999999 ? __('Unlimited Tokens') : number_format($package->ai_tokens) . ' ' . ($package->ai_tokens === 1 ? __('Token') : __('Tokens')) }}
                                                        </li>
