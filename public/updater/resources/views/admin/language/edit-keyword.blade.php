...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Admin Frontend Keywords') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Admin Frontend Keywords') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body   pb-5" id="app">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post"
                                action="{{ !empty($la) ? route('admin.language.update_admin_front_keyword', $la->id) : route('admin.language.update_admin_front_keyword', 0) }}"
                                id="langForm">
                                {{ csrf_field() }}
