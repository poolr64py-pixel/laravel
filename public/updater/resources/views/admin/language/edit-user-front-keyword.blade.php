...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('User Frontend Keywords') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('User Frontend Keywords') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body   pb-5" id="app">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post"
                                action="{{ route('admin.language.update_user_frontend_keyword', $la->id) }}" id="langForm">
                                {{ csrf_field() }}
