                    ...
                    <div class="card-body pt-5 pb-5">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                ...
                                <div class="form-group">
                                    <label>{{ __('SMTP Host') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('SMTP Port') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('Encryption') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('SMTP Username') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('SMTP Password') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('From Email') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('From Name') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
