                            ...
                            <form id="ajaxForm" class="modal-form" action="{{ route('admin.popup.update') }}"
                                ...
                                @if ($type == 2 || $type == 3)
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">{{ __('Background Color Opacity') }} <span class="text-danger">{{ '*' }}</span></label>
                                                <input type="number" class="form-control " name="background_opacity"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control jscolor " name="button_color"
                                ...
                                <div class="form-group">
                                    <label for="">{{ __('Delay') }} ({{ __('miliseconds') }}) <span class="text-danger">{{ '*' }}</span></label>
