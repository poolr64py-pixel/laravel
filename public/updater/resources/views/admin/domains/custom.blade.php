...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ empty(request()->input('type')) ? 'All' : __(ucfirst(request()->input('type'))) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 offset-lg-2 mt-2 mt-lg-0">
                            ...
                            <form action="{{ request()->url() }}" class="float-right d-flex">
                                ...
                                <input name="domain" class="min-w-250 form-control" type="text"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($rcDomains as $rcDomain)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td><span class="badge badge-danger">{{ __('Deleted') }}</span>
                                                        </td>
                                                    @endif
