                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="#" class="btn btn-primary float-right btn-sm mr-3" data-toggle="modal"
                                data-target="#sideImageModal"><i class="fas fa-plus"></i> {{ __('Add Slider Image') }}</a>
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxForm" class="modal-form" action="{{ route('admin.testimonial.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="rating" value=""
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxEditForm" action="{{ route('admin.testimonial.sideImageStore') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 showImage mb-3">
                                        @if (!is_null($abe->testimonial_img))
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('Close') }}</button>
                    <button id="updateBtn" type="submit" class="btn btn-primary">{{ __('Submit') }}</button>
                </div>
                </form>
            </div>
        </div>
