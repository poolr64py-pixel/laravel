                            ...
                            <select name="language" class="form-control language-select langBtn">
                                ...
                                @foreach ($adminLangs as $lang)
                                    <option value="{{ $lang->code }}"
                                        {{ $lang->code == Session::get('admin_lang') ? 'selected' : '' }}>
                                        {{ $lang->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <input type="hidden" id="setLocale" value="{{ route('admin.change.dashboard_language') }}">
                    @endif
                </li>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            ...
                            <li>
                                ...
                                <a class="dropdown-item"
                                    href="{{ route('admin.editProfile') }}">{{ __('Edit Profile') }}</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
