                    ...
                    <ul class="pricing-content">
                        ...
                        @foreach ($allPfeatures as $feature)
                            <li class="{{ is_array($pFeatures) && in_array($feature, $pFeatures) ? '' : 'disabled' }}">
                                ...
                                @elseif ($feature === 'AI Content Generation')
                                    @php
                                        $hasFeature = is_array($pFeatures) && in_array($feature, $pFeatures);
                                    @endphp

                                    <i
                                        class="{{ $hasFeature ? 'fal fa-check badge-success text-white' : 'fal fa-times bg-danger text-white' }}"></i>
                                    ...
                                    @if ($hasFeature)
                                        <ul class="list-unstyled ms-5 py-2" >
                                            <li>
                                                <i class="fal fa-check badge-success text-white"></i>
                                                {{ $package->ai_tokens === 999999 ? __('Unlimited') : $package->ai_tokens . ' ' }}
                                                {{ $package->ai_tokens === 1 ? __('AI Token') : __('AI Tokens') }}
                                            </li>
                                            <li class="" >
                                                <i class="fal fa-check badge-success text-white"></i>
                                                {{ __('Available for Property & Project Creation') }}
                                            </li>
                                            <li class="" >
                                                <i class="fal fa-check badge-success text-white"></i>
                                                {{ __('Powered by Google Gemini') }}
                                            </li>
                                        </ul>
                                    @endif

                                    {{-- AI Image Generation Feature --}}
                                @elseif ($feature === 'AI Image Generation')
                                    @php
                                        $hasFeature = is_array($pFeatures) && in_array($feature, $pFeatures);
                                    @endphp

                                    <i class="{{ $hasFeature ? 'fal fa-check' : 'fal fa-times' }}"></i>
                                    ...
                                    @if ($hasFeature)
                                        <ul class="list-unstyled ms-5 py-2" style="font-size: 0.85rem;">
                                            <li>
                                                <i class="fal fa-check badge-success text-white"></i>
                                                {{ __('Unlimited Images') }}
                                            </li>
                                            ...
                                            <li class="" >
                                                <i class="fal fa-check badge-success text-white"></i>
                                                {{ __('Powered by Pollinations.ai Flux Model') }}
                                            </li>
                                        </ul>
                                    @endif
