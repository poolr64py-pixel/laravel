    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger pb-1 dis-none" id="propertyErrors2">
                ...
                <form id="propertyForm2" class="modal-form"
                    ...
                    <div id="accordion" class="mt-3">
                        @foreach ($tenantFrontLangs as $language)
                            <div class="version">
                                <div class="version-header" id="eheading{{ $language->id }}">
                                    <h5 class="mb-0">
                                        <button type="button" class="btn btn-link" data-toggle="collapse"
                                            data-target="#ecollapse{{ $language->id }}"
                                ...
                                <div id="ecollapse{{ $language->id }}"
                                    class="collapse {{ $language->is_default == 1 ? 'show' : '' }}"
                                    aria-labelledby="eheading{{ $language->id }}" data-parent="#accordion">
                                    <div class="version-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div
                                                    class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                    <label>{{ __('Minimum Area (sqft)') }} <span
                                                            class="text-danger">{{ '*' }}</span> </label>
                                        ...
                                        <div class="row">
                                            <div class="col"> 
                                                @foreach ($tenantFrontLangs as $language)
                                                    @continue($language->id == $tenantFrontCurrLang->id)

                                                    <div class="form-check py-0">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox"
                                                                onchange="cloneInput('ecollapse{{ $tenantFrontCurrLang->id }}', 'ecollapse{{ $language->id }}', event)">
