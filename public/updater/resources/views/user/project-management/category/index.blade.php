...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('user.project_management.categories') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3  mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('user.project_management.bulk_delete_category') }}">
                        ...
                        <div class="col-lg-12">
                            @if (count($categories) == 0)
                                <h3 class="text-center mt-2">
                                    {{ __('NO PROJECT CATEGORY FOUND') }}</h3>
                            @else
                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                    ...
                                                    @if ($userBs->theme_version == 3)
                                                        <td>
                                                            ...
                                                            <form id="featureForm{{ $category->id }}"
                                                                ...
                                                                action="{{ route('user.project_management.update_category_featured') }}"
                                                                method="post">
                                                                @csrf
                                                ...
                                                @endphp
                                                            ...
                                                            data-image="{{ asset('assets/img/project-category/' . $category?->image) }}"
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('user.project_management.delete_category') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('user.project-management.category.create')

    {{-- edit modal --}}
    @include('user.project-management.category.edit')
@endsection
