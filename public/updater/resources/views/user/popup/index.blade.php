                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="{{ route('user.announcement_popups.select_popup_type', ['language' => request()->input('language')]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($popups as $popup)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset(Constant::WEBSITE_ANNOUNCEMENT_POPUP_IMAGE . '/' . $popup->image) }}"
                                                            alt="popup image" width="55">
                                                    </td>
                                                    <td>{{ convertUtf8($popup->name) }}</td>
                                                    <td>
                                                        <img src="{{ asset(Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE . '/' . $popup->type . '.jpg') }}"
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1"
                                                            href="{{ route('user.announcement_popups.edit_popup', ['id' => $popup->id]) }}">
