                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('user.blog_management.bulk_delete_category') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('user.blog_management.delete_category', ['id' => $category->id]) }}"
                                                            method="post">
