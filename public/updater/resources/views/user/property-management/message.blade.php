...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Property Messages') }}
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <form action="{{ route('user.property_management.messages') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                                            ...
                                            @foreach ($messages as $message)
                                                <tr>
                                                    ...
                                                    <td class="table-title">
                                                        ...
                                                        <a href="{{ route('frontend.property.details', [$tenant->username, 'slug' => $message->slug]) }}"
                                                            target="_blank">
    ...
    {{-- edit modal --}}
    @include('user.property-management.message-view')
@endsection
