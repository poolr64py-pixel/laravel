...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Edit Sections') }}</h4>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('user.about.additional_sections', ['language' => $defaultLang->code]) }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="pageForm"
                                action="{{ route('user.about.additional_section.update', ['id' => $section->id]) }}"
                                method="POST">
