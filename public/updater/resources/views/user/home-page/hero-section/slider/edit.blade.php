    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Slider') }}
                </h5>
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form" action="{{ route('user.home_page.update_slider') }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="text" rows="5" placeholder="{{ __('Enter Text') }}" id="intext"></textarea>
                    </div>
