                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxEditForm" action="{{ route('agent.update_password', getParam()) }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label>{{ __('Current Password') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('New Password') }} <span class="text-danger">{{ '*' }}</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>{{ __('Confirm New Password') }} <span
