    <div class="modal fade" id="aiContentModal" tabindex="-1" role="dialog" aria-labelledby="aiContentModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="aiContentForm" action="{{ route('agent.property.ai.generate', getParam()) }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="ai_property_type">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="ai_purpose" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ai_amenities[]" class="form-control js-example-basic-single2"
                                multiple="multiple">
                                @foreach ($amenities as $amenity)
                                    <option value="{{ $amenity->id }}">
                                        {{ @$amenity->getContent($defaultLang->id)->name }}</option>
                                @endforeach
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="ai_area">{{ __('Area (sqft)') }}</label>
                            <input type="text" class="form-control" id="ai_area" name="ai_area"
