        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Property Messages') }}</div>
                        </div>
                        <div class="col-lg-3">
                            <form action="{{ route('agent.property_message.index', getParam()) }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                                            ...
                                            @foreach ($messages as $message)
                                                <tr>
                                                    ...
                                                    <td class="table-title">
                                                        ...
                                                        <a href="{{ route('frontend.property.details', [getParam(), 'slug' => $message->slug]) }}"
                                                            target="_blank">
