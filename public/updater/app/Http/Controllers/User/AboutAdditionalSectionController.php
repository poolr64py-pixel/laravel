...
class AboutAdditionalSectionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('user.about-page.index', $information);
    }
    ...
    public function create(Request $request)
    {
        ...
        $information['all_sections'] = CustomSection::AboutUsPage();
        $information['tenantLangs'] = $this->allLangs($tenantId);
        $information['defaultLang'] = $this->defaultLang($tenantId);
        return view('user.about-page.create', $information);
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($languages as $language) {
            ...
            $messages[$language->code . '_section_name.required'] = __('The section title is required for') . ' ' . $language->name . ' language.';
            $messages[$language->code . '_content.required']  = __('The section content is required for') . ' ' . $language->name . ' language.';
        }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('user.about-page.edit', $information);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($languages as $language) {
            ...
            $code = $language->code;
            if ($request->filled($code . '_section_name') || $request->filled($code . '_content')) {
