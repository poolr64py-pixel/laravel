...
// Fix para links do sidebar que estão sendo interceptados pelo atlantis.js
(function($) {
    'use strict';
    $(document).ready(function() {
        // Aguardar um pouco para garantir que atlantis.js já aplicou seus handlers
        setTimeout(function() {
            $('.nav-item a').off('click').on('click', function(e) {
                ...
                // Se não tem submenu e tem href válido, navegar normalmente
                else if (href && href !== '#' && !$this.attr('data-toggle')) {
                    e.preventDefault();
                    e.stopPropagation();
