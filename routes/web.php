...
// Rotas para subdomínio imoveis
/*        Route::redirect("/","/imoveis");
    Route::group(['middleware' => 'setlang'], function () {
        Route::get('/', 'Front\FrontendController@index')->name('imoveis.index');
        Route::get('/templates', 'Front\FrontendController@templates')->name('imoveis.templates');
        Route::get('/vcards', 'Front\FrontendController@vcards')->name('imoveis.vcards');
        Route::post('/subscribe', 'Front\FrontendController@subscribe')->name('imoveis.subscribe');
        Route::get('/listings', 'Front\FrontendController@users')->name('imoveis.user.view');
        Route::get('/contact', 'Front\FrontendController@contactView')->name('imoveis.contact');
        Route::get('/faq', 'Front\FrontendController@faqs')->name('imoveis.faq.view');
        Route::get('/blog', 'Front\FrontendController@blogs')->name('imoveis.blogs');
        Route::get('/pricing', 'Front\FrontendController@pricing')->name('imoveis.pricing');
        Route::get('/blog-details/{slug}/{id}', 'Front\FrontendController@blogdetails')->name('imoveis.blogdetails');
        Route::get('/registration/step-1/{status}/{id}', 'Front\FrontendController@step1')->name('imoveis.register.view');
...
Route::domain($domain)->group(function () {
    ...
    // cron job for sending expiry mail
    Route::get('/expired', 'CronJobController@expired')->name('cron.check_expired');
    Route::get('/expiry-reminder', 'CronJobController@expired')->name('cron.expiry_reminder');
    ...
    Route::group(['middleware' => 'setlang'], function () {
        ...
        Route::get('/contato', 'Front\FrontendController@contactView')->name('front.contato');
...
Route::get('/projetos/{slug}', 'Front\FrontendController@projectDetail')->name('front.project.detail');
    ...
    ******************* User Routes *************************
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus', 'Demo']], function () {
        ...
        Route::get('/contact', 'Admin\ContactController@index')->name('user.contact');
        Route::post('/contact/update/{language}', 'Admin\ContactController@update')->name('user.contact.update');
...
//         Route::post('/home_page/brand_section/delete_brand', 'User\BrandSectionController@deleteBrand')->name('user.home_page.brand_section.delete_brand');
        ...
        Route::group(['middleware' => 'checkUserPermission:Ecommerce'], function () {
            ...
            Route::post('/item/settings', 'User\ItemController@updateSettings')->name('user.item.settings.updatey
');
...
Route::get('/debug-lang', function() {
    return response()->json([
        'frontend_lang' => session('frontend_lang'),
